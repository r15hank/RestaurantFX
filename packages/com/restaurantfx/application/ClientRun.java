...
public class ClientRun extends Application {
	...
	public static final void setStage(Stage stage) {ClientRun.stage = stage;}
	...
	public void start(Stage primaryStage) {
		try {
			...
			BorderPane root = (BorderPane)FXMLLoader.load(getClass().getResource("../view/ClientUI.fxml"));
			animate(root);
			Scene scene = new Scene(root);
			primaryStage.setScene(scene);
			primaryStage.centerOnScreen();
			primaryStage.initStyle(StageStyle.TRANSPARENT);
			primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("../resources/food_client.png")));
			primaryStage.show();
		} catch(Exception e) {
			e.printStackTrace();
		}
